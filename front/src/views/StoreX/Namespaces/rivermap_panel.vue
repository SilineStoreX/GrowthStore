        ...
        <el-scrollbar>
            <el-form label-width="160px" :inline="false">
                ...
                <el-collapse v-model="activeNames">
                  <el-collapse-item title="数据图谱配置" name="info">                
                    <el-form-item label="数据集写入地址">
                        <el-input v-model="rest_conf.store_uri" />
                    </el-form-item>
                    <el-form-item label="数据字典URI">
                        <el-input v-model="rest_conf.dict_uri" />
                    </el-form-item>
                    <el-form-item label="范围区间URI">
                        <el-input v-model="rest_conf.range_uri" />
                    </el-form-item>
                    <el-form-item label="图数据库URI">
                        <el-input v-model="rest_conf.datagraph_uri" />
                    </el-form-item>
                  </el-collapse-item>
                </el-collapse>
            </el-form>
