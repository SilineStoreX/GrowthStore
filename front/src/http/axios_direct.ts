 ...
 */
function createAxiosDirect<Data = any, T = ApiPromise<Data>>(axiosConfig: AxiosRequestConfig, options: Options = {}, loading: LoadingOptions = {}): T {
    ...
    Axios.interceptors.request.use(
        (config) => {
            ...
            const token = options.anotherToken && options.anotherToken !== '' ? options.anotherToken : globalStore.api_token;
...
export default createAxiosDirect
